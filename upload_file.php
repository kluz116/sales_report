...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Upload Report <small>List of sales</small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<div class="col-md-12">
				    <div class="panel panel-inverse">
						...
						<div class="panel-body">
							<form method="POST" enctype="multipart/form-data" action="">
								 ...
								 ?>
			                         <div align="center">
			                                  <p>Select CSV file: <input type="file" name="file" class="form-control"  /></p>
			                                  <p><input type="submit"  name="importSubmit" value="Upload"  class="btn btn-success" /></p>
			                         </div>
			                </form>
						</div>
					</div>
